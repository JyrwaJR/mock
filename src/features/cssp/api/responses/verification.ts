...
export const VERIFICATION_VARIANTS = {
  ...
  success: { status: 200, body: { msg: "", self_ver_code: "1" } },
  /** Faces not similar; sentinel code '22' (verification.py:230). */
  photo_not_matched: { status: 200, body: { msg: "Failed. Photo does not matched", self_ver_code: "22" } },
  ...
  maintenance: {
    status: 400,
    body: { msg: " Failed!Please try again later. Server is under maintenance." },
  },
